...
parser.add_argument("--input_dir", type=str, default="/data/input", help="Directory containing input tiff files")
parser.add_argument("--output_dir", type=str, default="/data/output", help="Directory to save output theta files")
...
net_path = os.path.join(opt.weights_dir, "net.pth")
g1_path = os.path.join(opt.weights_dir, "generator1.pth")
g2_path = os.path.join(opt.weights_dir, "generator2.pth")
